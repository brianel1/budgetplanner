...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($amount) || !is_numeric($amount) || $amount <= 0) {
        ...
        try {
            $transactionModel->update($transaction_id, $userId, $amount, $category_id, $transaction_date, $description, $type);
...
$pageTitle = 'Edit Transaction - BudgetPlanner';
                ...
                <form method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" class="form-control" name="amount" step="0.01" min="0.01"
                                           placeholder="0.00" value="<?php echo htmlspecialchars($transaction['amount']); ?>" required>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                        ...
                        <select class="form-select" name="category_id" required>
                            ...
                            ?>
                                <option value="<?php echo $category['category_id']; ?>"
                                        <?php echo ($transaction['category_id'] == $category['category_id']) ? 'selected' : ''; ?>>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" name="description" rows="3"
                                  placeholder="Add a note about this transaction"><?php echo htmlspecialchars($transaction['description']); ?></textarea>
                    </div>
